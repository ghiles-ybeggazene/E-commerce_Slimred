...
FROM  produit INNER JOIN categorie ON (produit.id_cat = categorie.id_cat) WHERE produit.id_cat=5');
...
<input type="hidden" name="prix_unt" value="'.$donnee['prix_unt'].'" />
quantite:<input type="number" name="quantite" required /></br></br>
<input type="submit" name="ajoute" value="ajout au panier" />
</p>
</form>';
